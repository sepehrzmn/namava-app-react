    ...
    return (
        <>
            <div className="badges">
                {dataContent?.ageRange?.value &&
                dataContent?.ageRange?.value !== "None" ? (
                    <div
                        className={`badge range r__${dataContent.ageRange.value}`}
                        title={dataContent?.ageRange?.caption ?? ""}
                    >
                        <span>{dataContent.ageRange.value}+</span>
                    </div>
                ) : (
                    ""
                )}
                {dataContent?.year && dataContent?.year !== "None" ? (
                    <div className="badge">
                        <span>{dataContent.year}</span>
                    </div>
                ) : (
                    ""
                )}
                {dataContent?.hit && dataContent?.hit !== "None" ? (
                    <div className="badge">
                        <svg
                        ...
                        <span>{dataContent.hit}%</span>
                    </div>
                ) : (
                    ""
                )}
                {dataContent?.mediaDuration &&
                dataContent?.mediaDuration !== "None" ? (
                    <div className="badge">
                        <span>{dataContent.mediaDuration} دقیقه</span>
                    </div>
                ) : (
                    ""
                )}

                {dataContent?.imdb && dataContent?.imdb !== "None" ? (
                    <div className="badge">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="35"
                        ...
                        <span>{dataContent.imdb}</span>
                    </div>
                ) : (
                    ""
                )}
                {dataContent?.hasExclusiveDub ? (
                    <div className="badge">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                        ...
                        <span>
                            {dataContent?.dubsType === "ExclusiveDubs"
                                ? "دوبله فارسی"
                                : "دوبله نماوا"}
                        </span>
                    </div>
                ...
                {dataContent?.hasPersianSubtitle ? (
                    <div className="badge">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
